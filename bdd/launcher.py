...
subprocess.call(r'pip install -r requirement.txt', shell=True)
subprocess.call(r'rmdir /S /Q Report_Json', shell=True)
subprocess.call(r'rmdir /S /Q Report_Html', shell=True)
subprocess.call(r'python Features\csv-for-feature-examples.py', shell=True)
subprocess.call(r'behave Features\TestCSV.feature -f allure_behave.formatter:AllureFormatter -o Report_Json', shell=True)
